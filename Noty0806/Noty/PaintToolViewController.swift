...
protocol PaintToolVCDelegate:class {
    func PaintToolViewControllerDidFinish(_ settingsVC:PaintToolViewController)
}

class PaintToolViewController: UIViewController {
    ...
    var delegate:PaintToolVCDelegate?
    ...
    @IBAction func dismiss(_ sender: Any) {
        if delegate != nil {
            delegate?.PaintToolViewControllerDidFinish(self)
        }
