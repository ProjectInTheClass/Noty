 ...
 */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let PaintToolViewController = segue.destination as! PaintToolViewController
        PaintToolViewController.delegate = self
        PaintToolViewController.red = red
        PaintToolViewController.green = green
        PaintToolViewController.blue = blue
        PaintToolViewController.brushSize = brushSize
        PaintToolViewController.opacityValue = opacityValue
    }
    
    
}

extension PaintingViewController:UINavigationControllerDelegate,UIImagePickerControllerDelegate,PaintToolVCDelegate {
    ...
    func PaintToolViewControllerDidFinish(_ settingsVC: PaintToolViewController) {
